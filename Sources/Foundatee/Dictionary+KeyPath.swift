...
//// Inspired by: https://oleb.net/blog/2017/01/dictionary-key-paths/
...
extension Dictionary where Key: StringProtocol {
    ...
    public subscript(keyPath keyPath: DictKeyPath) -> Any? {
        get {
...
extension Dictionary where Key: StringProtocol {
    ...
    public subscript(string keyPath: DictKeyPath) -> String? {
        get { return self[keyPath: keyPath] as? String }
        set { self[keyPath: keyPath] = newValue }
    }

    public subscript(dict keyPath: DictKeyPath) -> [Key: Any]? {
